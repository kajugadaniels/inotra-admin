                ...
                <div className="flex flex-col gap-6 sm:flex-row sm:items-start sm:justify-between">
                    ...
                    <div className="flex w-full flex-col gap-3 sm:w-auto sm:items-end">
                        ...
                        <div className="flex w-full flex-wrap items-center gap-2 sm:w-auto sm:flex-nowrap sm:justify-end">
                            ...
                            <Button asChild className="h-11 w-full rounded-full text-xs font-semibold sm:w-auto">
                        ...
                        <div className="flex w-full flex-col gap-3 sm:w-auto sm:flex-row sm:items-center sm:justify-end">
                            <div className="inline-flex w-full rounded-full border border-border/60 bg-background/50 p-1 sm:w-auto">
                                <button
                                    type="button"
                            ...
                            {(isLoading || isLoadingMore) && (
                                <div className="inline-flex w-full items-center justify-center gap-2 rounded-full border border-border/60 bg-background/60 px-3 py-2 text-xs text-muted-foreground sm:w-auto">
