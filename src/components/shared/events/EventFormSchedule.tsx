...
const EventFormSchedule = ({ form, setForm }: Props) => {
        ...
        return (
            <div className="space-y-4">
                <p className="text-sm text-muted-foreground">
                    Set NEXT_PUBLIC_GOOGLE_MAP_API_KEY in admin/.env to enable map and address suggestions.
                </p>
            </div>
        );
    }
    ...
    return (
        <APIProvider apiKey={apiKey}>
            <EventFormScheduleContent form={form} setForm={setForm} />
        </APIProvider>
    );
};
...
const EventFormScheduleContent = ({ form, setForm }: Props) => {
            ...
            <div className="space-y-2">
                <div className="flex items-center justify-between">
                    ...
                    <div className="grid grid-cols-2 gap-2 text-xs text-muted-foreground">
                        <Input value={form.latitude} placeholder="Lat" readOnly className="h-8 text-xs" />
                        <Input value={form.longitude} placeholder="Lng" readOnly className="h-8 text-xs" />
                    </div>
                </div>
