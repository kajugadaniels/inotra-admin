...
import ListingRequestsFilters, { type ListingRequestFiltersState } from "./ListingRequestsFilters";

type ListingRequestsHeaderProps = {
...
const ListingRequestsHeader = ({
    filters,
    categories,
    isLoading,
    onFiltersChange,
    onReset,
}: ListingRequestsHeaderProps) => {
    return (
            ...
            <div className="flex flex-col gap-5 lg:flex-row lg:items-start lg:justify-between">
                <div className="min-w-0">
                    ...
                    <p className="mt-2 max-w-2xl text-xs leading-relaxed text-muted-foreground">
                        Review incoming listing submissions and track their approval status.
                    </p>
                </div>

                <div className="flex w-full flex-col gap-3 lg:w-auto lg:items-end">
                    <div className="flex flex-wrap items-center gap-2">
                        <ListingRequestsFilters
                            filters={filters}
                    ...
                    <div className="relative w-full sm:w-[380px]">
                        ...
                        <Input
                            ...
                            placeholder="Search submissions by name, city, or submitter"
...
export default ListingRequestsHeader;
