...
export type CustomerRepFiltersState = {
    search: string;
    ordering:
        | "date_joined"
        | "email"
...
export const defaultCustomerRepFilters: CustomerRepFiltersState = {
    search: "",
...
const CustomerRepFilters = ({ filters, isLoading, onFiltersChange, trigger }: Props) => {
    const [dialogOpen, setDialogOpen] = useState(false);
    const [draftFilters, setDraftFilters] = useState<CustomerRepFiltersState>(filters);
    ...
    return (
        <Dialog open={dialogOpen} onOpenChange={handleOpenChange}>
            ...
            <DialogContent className="max-w-xl rounded-3xl border-border/60 bg-background backdrop-blur-xl">
                <DialogHeader>
                    <DialogTitle>Filter customer reps</DialogTitle>
                    <DialogDescription>
                    ...
                    <div>
                        ...
                        <Select
                            ...
                            onValueChange={(value) =>
                                setDraftFilters({
                                    ...draftFilters,
                                    ordering: value as CustomerRepFiltersState["ordering"],
                                })
                            }
                        >
...
export default CustomerRepFilters;
