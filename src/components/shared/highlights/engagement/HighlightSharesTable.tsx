...
import type { HighlightShare } from "@/api/types";
...
const HighlightSharesTable = ({ rows, isLoading }: Props) => {
    return (
            ...
            <Table>
                ...
                <TableBody>
                    {isLoading ? (
                        ...
                        <TableRow>
                            <TableCell colSpan={6} className="py-10 text-center text-xs text-muted-foreground">
                                No shares found for the selected filters.
                            </TableCell>
                        </TableRow>
                    ) : (
                        rows.map((row) => {
...
export default HighlightSharesTable;
