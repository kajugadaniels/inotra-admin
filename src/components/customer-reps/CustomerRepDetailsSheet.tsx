...
import { Mail, Phone, Shield, UserCheck, UserX } from "lucide-react";
...
const CustomerRepDetailsSheet = ({ user, open, onOpenChange }: Props) => {
    ...
    return (
        <Sheet open={open} onOpenChange={onOpenChange}>
            <SheetContent className="w-full max-w-lg overflow-y-auto">
                <SheetHeader>
                    <SheetTitle>Customer rep details</SheetTitle>
                    <SheetDescription>Profile and status for this representative.</SheetDescription>
                </SheetHeader>
...
export default CustomerRepDetailsSheet;
